    ...
    <body>
        <div class="layout layout-nav-side">
            <div class="navbar navbar-expand-lg bg-dark navbar-dark sticky-top">
                ...
                <img alt="Pipeline" src="{{ asset('images/admin_avatar/logo.png')}}" style="width: 80px;" />
                </a>
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-block d-lg-none ml-2">
                        <div class="dropdown">
                            ...
                            <img alt="Image" src="{{ asset('images/admin_avatar/logo.png')}}" style="width: 80px; class="avatar" />
                            </a>
                ...
                <div class="d-none d-lg-block">
                    <div class="dropup">
                        <a href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img alt="Image" src="{{ asset('images/admin_avatar/logo.png')}}" style="width: 40px; class="avatar" />
                        </a>
