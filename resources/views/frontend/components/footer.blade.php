    ...
    <div class="wrp">
        <div class="top">
            <div class="left">
                ...
                <div class="cont fs16">
                    <b>CÔNG TY CỔ PHẦN TRỰC TUYẾN SUPERWATCH.</b>
                </div>
                <ul style="display: block;">
                    <li>
                        <span class="icon"><i class="fas fa-map-marker-alt"></i></span>
                        <span class="text">VPGD: Số 55 Mậu Thân, Ninh Kiều, Tp.Cần Thơ.</span>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <a href="mailto:contact@superwatch.vn" title="email" class="text">contact@superwatch.vn</a>
                    </li>
                </ul>
            </div>
            <div class="mid">
            ...
            <div class="right">
                ...
                <div class="dangky">
                    ...
                    <img data-src="{{ asset('css/icon/bct2.png') }}" alt="BCT" class="lazy" src="{{ asset('images/lazy.jpg') }}">
                    </a>
                    <a rel="nofollow" href="http://online.gov.vn/Home/WebDetails/2912" title="BTC" target="_blank">
                    <img data-src="{{ asset('css/icon/bct.png') }}" alt="BCT" class="lazy" src="{{ asset('images/lazy.jpg') }}">
                    </a>
                </div>
            </div>
        </div>
        <div class="bot">
            <p class="fRobotoB pb5 fs16">SuperWatch</p>
            <h4 class="lh21">
...
<div id="commonBot">
    <div class="wrp">
        <div class="left">
            Copyright © 2012-2022 SuperWatch.
        </div>
        <ul class="right">
            <li>
                <a href="https://daugia.tv" title="Dau gia">
                <img data-src="{{ asset('icon/LogoDauGia1.png') }}" alt="Dau gia" class="lazy" src="{{ asset('images/lazy.jpg') }}">
                </a>
            </li>
            <li>
                <a href="https://www.kinhmatdangquang.vn" title="Kinh mat">
                <img data-src="{{ asset('icon/LogoKinhMat1.png') }}" alt="KInh mat" class="lazy" src="{{ asset('images/lazy.jpg') }}">
                </a>
            </li>
        </ul>
    </div>
