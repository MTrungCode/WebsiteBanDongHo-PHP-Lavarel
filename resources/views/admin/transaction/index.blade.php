...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{ route('admin.transaction.index') }}"></i> Transaction</a></li>
                                ...
                                @if (isset($transactions))
                                    @foreach($transactions as $transaction)
                                        <tr>
                                            ...
                                            <td>
                                                <a data-id="{{ $transaction->id }}" href="{{ route('ajax.admin.transaction.detail', $transaction->id) }}" class="btn btn-xs btn-info js-preview-transaction" title="Xem chi tiết"><i class="fa fa-eye"></i></a>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li>
                                                            <a href="{{ route('admin.transaction.delete', $transaction->id) }}" title="Xóa"><i class="fa fa-trash-o"></i> Delete</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('admin.action.transaction', ['process', $transaction->id]) }}"><i class="fa fa-ban"></i> Đang giao hàng</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('admin.action.transaction', ['success', $transaction->id]) }}"><i class="fa fa-ban"></i> Đã giao hàng</a>
                                                        </li>
                                                        <li>
