...
$(document).ready(function () {
    $('#slide').owlCarousel(owlslide($('#slide').find('>*').length, 10, true, true, false, 1, 1, 1, 1, 1, "fadeIn", "fadeOut"));  
    $('#star .group').owlCarousel(owlslide($('#star .group').find('>*').length, 25, true, false, true, 2, 3, 3, 4, 4, "", ""));
    $('.product .group.slide3').owlCarousel(owlslide($('.product .group.slide3').find('>*').length, 0, true, false, true, 2, 3, 4, 4, 4, "", ""));

    var wWindow = $(window).width();
    if (wWindow > 767) {
        $('.product .group.slide').owlCarousel(owlslide($('.product .group.slide').find('>*').length, 30, true, false, true, 2, 3, 4, 5, 5, "", ""));
        $('.product .group.slide2').owlCarousel(owlslide($('.product .group.slide2').find('>*').length, 20, true, false, true, 2, 3, 2, 3, 3, "", ""));
    } else {
    ...
    if (wWindow <= 1199) {
        $(".otherPro.slideRes .group").owlCarousel(owlslide($('.otherPro.slideRes .group').find('>*').length, 20, true, false, true, 2, 3, 3, 3, 3, "", ""));
    }
